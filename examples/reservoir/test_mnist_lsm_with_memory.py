...
exp = experiment.Experiment(input_start=0,input_delay=0,training_start=memory_size-1,
...
lsm_output_conn = conn_random.create_xavier_connection("lsm_output_conn", memory_size*width, output_layer_size)
exp.add_trainable_connection("output_conn",
                             connection.WeightedConnection(g_lsm_memory,
